...
module.exports = async function handler(req, res) {
  ...
  try {
    if (req.method === "GET") {
      ...
      return res.json(r.rows[0] ? r.rows[0].value : []);
    }
    ...
    if (req.method === "POST") {
      ...
      await pool.query(
        "INSERT INTO bd_store (key, value, updated_at) VALUES ($1, $2::jsonb, NOW()) ON CONFLICT (key) DO UPDATE SET value = $2::jsonb, updated_at = NOW()",
