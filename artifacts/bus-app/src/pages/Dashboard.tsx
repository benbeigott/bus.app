      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06] bg-[#050505] sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="text-xs border border-yellow-500/40 text-yellow-500 px-3 py-1.5 rounded hover:bg-yellow-500/10 hover:border-yellow-500 transition-all font-medium flex items-center gap-1.5"
